(function(module) {
  ...
  module.controller('SearchEmpMissionController', ['$scope', 'missionEmployeeService', 'alertsService', '$state', 'searchManager', 'modalService', '$rootScope',
    function($scope, missionEmployeeService, alertsService, $state, searchManager, modalService, $rootScope) {

      $scope.searchManager = searchManager;

      $scope.deleteMission = function(internalmission) {
        ...
        modalInstance.result.then(function() {
        	missionEmployeeService.deleteMission(internalmission.id).then(function(data) {
      ...
      $scope.editMission = function(internalmission) {
        ...
        if (angular.equals(internalmission.status, "Scheduled")) {
          ...
          modalInstance.result.then(function() {
        	  missionEmployeeService.setMissionToDraft(internalmission.id).then(function(data) {
                  alertsService.addAlert({
                    title: 'Success',
      ...
      $scope.copyMission = function(internalmission) {
          ...
          modalInstance.result.then(function() {
        	...
        	missionEmployeeService.copyMission(internalmission.id).then(function(data) {
              alertsService.addAlert({
                title: 'Success',
